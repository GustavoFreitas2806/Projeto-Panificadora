...
create table if not exists tb_produto (
	...
	constraint fk_categoria_produto foreign key (idCategoria) references tb_categoria(idCategoria),
...
INSERT into
	tb_administrador (nm_email, nm_senha)
VALUES
	('sonhomeu@gmail.com', 'sonhomeu');
